...
function cargaimaeditext(){
  ...
  game.load.image('btf1', 'assets/sprites/btf1.png');
  game.load.image('btf2', 'assets/sprites/btf2.png');
  game.load.image('btf3', 'assets/sprites/btf3.png');
  game.load.image('btcero', 'assets/sprites/btcero.png');
  game.load.image('btuno', 'assets/sprites/bt1.png');




   game.load.image('btmenos', 'assets/sprites/btmenos.png');


     game.load.image('btmas', 'assets/sprites/btmas.png');



      game.load.image('btdos', 'assets/sprites/btdos.png');

      game.load.image('bt3', 'assets/sprites/bt3.png');
       game.load.image('bt4', 'assets/sprites/bt4.png');

        game.load.image('bt5', 'assets/sprites/bt5.png');

        game.load.image('bt6', 'assets/sprites/bt6.png');

        game.load.image('bt7', 'assets/sprites/bt7.png');

        game.load.image('bt8', 'assets/sprites/bt8.png');

        game.load.image('bt9', 'assets/sprites/bt9.png');

         game.load.image('btx', 'assets/sprites/btx.png');

         game.load.image('btmulti', 'assets/sprites/btmulti.png');

         game.load.image('btdiv', 'assets/sprites/btdiv.png');
         game.load.image('btpote', 'assets/sprites/btpote.png');

         game.load.image('btparenizq', 'assets/sprites/btparenizq.png');

          game.load.image('btparender', 'assets/sprites/btparender.png');

          game.load.image('btac', 'assets/sprites/btac.png');

          game.load.image('btflechad', 'assets/sprites/btflechad.png');
 game.load.image('btflechai', 'assets/sprites/btflechai.png');
  ...
  game.load.image('btdel', 'assets/sprites/btdel.png');
  game.load.image('bte', 'assets/sprites/bte.png');
  game.load.image('btigual', 'assets/sprites/btigual.png');
  game.load.image('btxy', 'assets/sprites/btxy.png');



  game.load.image('btxmin', 'assets/sprites/btxmin.png');

  game.load.image('btxmax', 'assets/sprites/btxmax.png');




  game.load.image('btsin', 'assets/sprites/btsin.png');

 game.load.spritesheet('btgrafi', 'assets/sprites/btgrafi.png',60, 60, 2);



  //game.load.image('sprite', 'assets/sprites/btcero.png');

   game.load.image('btpunto', 'assets/sprites/btpunto.png');
  game.load.spritesheet('cualquiera', 'assets/sprites/cualquiera.png', 60, 60)





 game.load.image('btcos', 'assets/sprites/btcos.png');
  game.load.image('bttan', 'assets/sprites/bttan.png');

   game.load.image('btcot', 'assets/sprites/btcot.png');

   game.load.image('btsec', 'assets/sprites/btsec.png');

   game.load.image('btcsc', 'assets/sprites/btcsc.png');

   game.load.image('btsinh', 'assets/sprites/btsinh.png');

   game.load.image('btcosh', 'assets/sprites/btcosh.png');
   game.load.image('bttanh', 'assets/sprites/bttanh.png');

   game.load.image('btcoth', 'assets/sprites/btcoth.png');

    game.load.image('btcsch', 'assets/sprites/btcsch.png');

    game.load.image('btsech', 'assets/sprites/btsech.png');

    game.load.image('btasin', 'assets/sprites/btasin.png');

     game.load.image('btacos', 'assets/sprites/btacos.png');

     game.load.image('btatan', 'assets/sprites/btatan.png');

      game.load.image('btacot', 'assets/sprites/btacot.png');

       game.load.image('btasec', 'assets/sprites/btasec.png');

        game.load.image('btacsc', 'assets/sprites/btacsc.png');




   game.load.image('btasinh', 'assets/sprites/btasinh.png');

   game.load.image('btacosh', 'assets/sprites/btacosh.png');
   game.load.image('btatanh', 'assets/sprites/btatanh.png');

   game.load.image('btacoth', 'assets/sprites/btacoth.png');

    game.load.image('btacsch', 'assets/sprites/btacsch.png');

    game.load.image('btasech', 'assets/sprites/btasech.png');
 game.load.image('btderi', 'assets/sprites/btderi.png');
